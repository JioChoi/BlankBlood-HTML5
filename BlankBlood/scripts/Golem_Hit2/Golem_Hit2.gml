			...
			if(mot_damt_00[motion,step_t]){
				...
				with(col){
					if(true){
						...
						global.bind += other.mot_damt_00[other.motion,other.step_t]+random(5);
						if(global.bind>100) global.bind = 100;

						pow = other.mot_atkspd_00[other.motion,other.step_t];
						if(other.dir) direct = other.mot_atkdir_00[other.motion,other.step_t];
						else direct = rev_angle(other.mot_atkdir_00[other.motion,other.step_t]);
						sound_play(global.SndHit_04);
						step = 0;image_index=0;
						if(global.HP[global.chara]<=0 && dmgkind != 22) alarm[11] = 1;
			...
			if(mot_damt_01[motion,step_t]){
				...
				with(col){
					if(true){
						...
						global.bind += other.mot_damt_01[other.motion,other.step_t]+random(5);
						if(global.bind>100) global.bind = 100;

						pow = other.mot_atkspd_01[other.motion,other.step_t];
						if(other.dir) direct = other.mot_atkdir_01[other.motion,other.step_t];
						else direct = rev_angle(other.mot_atkdir_01[other.motion,other.step_t]);
						sound_play(global.SndHit_04);
						step = 0;image_index=0;
						if(global.HP[global.chara]<=0 && dmgkind != 22) alarm[11] = 1;
						//instance_change(objDamage,false);
			...
			if(mot_damt_02[motion,step_t]){
				...
				with(col){
					if(true){
						...
						global.bind += other.mot_damt_02[other.motion,other.step_t]+random(5);
						if(global.bind>100) global.bind = 100;

						pow = other.mot_atkspd_02[other.motion,other.step_t];
						if(other.dir) direct = other.mot_atkdir_02[other.motion,other.step_t];
						else direct = rev_angle(other.mot_atkdir_02[other.motion,other.step_t]);
						sound_play(global.SndHit_04);
						step = 0;image_index=0;
						if(global.HP[global.chara]<=0 && dmgkind != 22) alarm[11] = 1;
						//instance_change(objDamage,false);
			...
			if(mot_damt_03[motion,step_t]){
				...
				with(col){
					if(true){
						...
						global.bind += other.mot_damt_03[other.motion,other.step_t]+random(5);
						if(global.bind>100) global.bind = 100;

						pow = other.mot_atkspd_03[other.motion,other.step_t];
						if(other.dir) direct = other.mot_atkdir_03[other.motion,other.step_t];
						else direct = rev_angle(other.mot_atkdir_03[other.motion,other.step_t]);
						sound_play(global.SndHit_04);
						step = 0;image_index=0;
						if(global.HP[global.chara]<=0 && dmgkind != 22) alarm[11] = 1;
						//instance_change(objDamage,false);
			...
			if(mot_damt_04[motion,step_t]){
				...
				with(col){
					if(true){
						...
						global.bind += other.mot_damt_04[other.motion,other.step_t]+random(5);
						if(global.bind>100) global.bind = 100;

						pow = other.mot_atkspd_04[other.motion,other.step_t];
						if(other.dir) direct = other.mot_atkdir_04[other.motion,other.step_t];
						else direct = rev_angle(other.mot_atkdir_04[other.motion,other.step_t]);
						sound_play(global.SndHit_04);
						step = 0;image_index=0;
						if(global.HP[global.chara]<=0 && dmgkind != 22) alarm[11] = 1;
						//instance_change(objDamage,false);
			...
			if(mot_damt_05[motion,step_t]){
				...
				with(col){
					if(true){
						...
						global.bind += other.mot_damt_05[other.motion,other.step_t]+random(5);
						if(global.bind>100) global.bind = 100;

						pow = other.mot_atkspd_05[other.motion,other.step_t];
						if(other.dir) direct = other.mot_atkdir_05[other.motion,other.step_t];
						else direct = rev_angle(other.mot_atkdir_05[other.motion,other.step_t]);
						sound_play(global.SndHit_04);
						step = 0;image_index=0;
						if(global.HP[global.chara]<=0 && dmgkind != 22) alarm[11] = 1;
						//instance_change(objDamage,false);
			...
			if(mot_damt_06[motion,step_t]){
				...
				with(col){
					if(true){
						...
						global.bind += other.mot_damt_06[other.motion,other.step_t]+random(5);
						if(global.bind>100) global.bind = 100;

						pow = other.mot_atkspd_06[other.motion,other.step_t];
						if(other.dir) direct = other.mot_atkdir_06[other.motion,other.step_t];
						else direct = rev_angle(other.mot_atkdir_06[other.motion,other.step_t]);
						sound_play(global.SndHit_04);
						step = 0;image_index=0;
						if(global.HP[global.chara]<=0 && dmgkind != 22) alarm[11] = 1;
						//instance_change(objDamage,false);
			...
			if(mot_damt_07[motion,step_t]){
				...
				with(col){
					if(true){
						...
						global.bind += other.mot_damt_07[other.motion,other.step_t]+random(5);
						if(global.bind>100) global.bind = 100;

						pow = other.mot_atkspd_07[other.motion,other.step_t];
						if(other.dir) direct = other.mot_atkdir_07[other.motion,other.step_t];
						else direct = rev_angle(other.mot_atkdir_07[other.motion,other.step_t]);
						sound_play(global.SndHit_04);
						step = 0;image_index=0;
						if(global.HP[global.chara]<=0 && dmgkind != 22) alarm[11] = 1;
						//instance_change(objDamage,false);
			...
			if(mot_damt_08[motion,step_t]){
				...
				with(col){
					if(true){
						...
						global.bind += other.mot_damt_08[other.motion,other.step_t]+random(5);
						if(global.bind>100) global.bind = 100;

						pow = other.mot_atkspd_08[other.motion,other.step_t];
						if(other.dir) direct = other.mot_atkdir_08[other.motion,other.step_t];
						else direct = rev_angle(other.mot_atkdir_08[other.motion,other.step_t]);
						sound_play(global.SndHit_04);
						step = 0;image_index=0;
						if(global.HP[global.chara]<=0 && dmgkind != 22) alarm[11] = 1;
						//instance_change(objDamage,false);
			...
			if(mot_damt_09[motion,step_t]){
				...
				with(col){
					if(true){
						...
						global.bind += other.mot_damt_09[other.motion,other.step_t]+random(5);
						if(global.bind>100) global.bind = 100;

						pow = other.mot_atkspd_09[other.motion,other.step_t];
						if(other.dir) direct = other.mot_atkdir_09[other.motion,other.step_t];
						else direct = rev_angle(other.mot_atkdir_09[other.motion,other.step_t]);
						sound_play(global.SndHit_04);
						step = 0;image_index=0;
						if(global.HP[global.chara]<=0 && dmgkind != 22) alarm[11] = 1;
						//instance_change(objDamage,false);
			...
			if(mot_damt_10[motion,step_t]){
				...
				with(col){
					if(true){
						...
						global.bind += other.mot_damt_10[other.motion,other.step_t]+random(5);
						if(global.bind>100) global.bind = 100;

						pow = other.mot_atkspd_10[other.motion,other.step_t];
						if(other.dir) direct = other.mot_atkdir_10[other.motion,other.step_t];
						else direct = rev_angle(other.mot_atkdir_10[other.motion,other.step_t]);
						sound_play(global.SndHit_04);
						step = 0;image_index=0;
						if(global.HP[global.chara]<=0 && dmgkind != 22) alarm[11] = 1;
						//instance_change(objDamage,false);
