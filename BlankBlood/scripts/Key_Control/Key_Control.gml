	...
	if(!global.ctrlmode){
		if(global.chara){
			...
			down	= keyboard_check(global.key[13]);
	 		b1	= mouse_check_button(1);
			b2	= mouse_check_button(2);
			...
			if( keyboard_check_pressed(global.key[13]) ) down	= 2;
	 		if( mouse_check_button_pressed(1) ) b1	= 2;
			if( mouse_check_button_pressed(2) ) b2	= 2;
			...
			if( keyboard_check_released(global.key[13]) ) down	= 3;
	 		if( mouse_check_button_released(1) ) b1	= 3;
			if( mouse_check_button_released(2) ) b2	= 3;
