...
{
{
	...
	case 11:
		image_speed = 0.5;
		if(dir == 0) draw_sprite_ext(global.SprP_Damage_11[0],-1,x,y,1,image_yscale,image_angle,image_blend,image_alpha);
		else draw_sprite_ext(global.SprP_Damage_11[0],-1,x,y,-1,image_yscale,image_angle,image_blend,image_alpha);
		break;
	case 21:
		image_speed = 0.5;
		if(dir == 0) draw_sprite_ext(global.SprP_Damage_21[0],-1,x,y,1,image_yscale,image_angle,image_blend,image_alpha);
		else draw_sprite_ext(global.SprP_Damage_21[0],-1,x,y,-1,image_yscale,image_angle,image_blend,image_alpha);
		break;
	}
}
}
